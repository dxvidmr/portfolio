...
<style>
	...
	.intro { max-width: 68ch; color: #a3a3a3; line-height: 1.6; }
	...
	input, select { min-width: 0; border: 1px solid #404040; background: #0a0a0a; color: #d4d4d4; padding: 0.5rem; font: inherit; font-size: 0.7rem; }
