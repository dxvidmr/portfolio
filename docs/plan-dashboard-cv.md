...
> Estado general: **Fases 5A–5E y 5G implementadas; migraciones hasta `012` aplicadas; deploy del 16/07 verificado en producción (CV, home y ficha con `talks`). Pendiente: commit + push de la 5E (taxonomías) y prueba editorial conjunta (5C enlaces, 5D documentos, 5G alta unificada, 5E taxonomías). Después: Fase 6 (calidad y limpieza; la 5F es condicional y queda fuera hasta tener consumidor)**
